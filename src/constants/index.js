...
export const projects = [
  {
    ...
    description:
      "Custom Discord bot development for moderation, tickets, utilities, automation, Minecraft communities, dashboards, and AI-powered features.",
    tags: [
      { name: "discord.py", color: "blue-text-gradient" },
...
export const SOCIAL_LINKS = {
  ...
  email: "developer@rawmilk3017.net",
};
